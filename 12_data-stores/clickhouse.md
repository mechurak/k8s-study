...
- **Headless Service**(`clusterIP: None`)와 짝지어 파드별 DNS(`clickhouse-0.clickhouse.<ns>.svc`)를 부여한다.

> StatefulSet·PV/PVC·StorageClass 개념 자체는 [`05_storage`](../05_storage/) 참고. 여기선 그걸 ClickHouse로 **실전 응용**한다.
